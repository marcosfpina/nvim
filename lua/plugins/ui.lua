...
-- Tokyo Night theme with enhanced customization
...
transparent = false, -- Use transparency
...
-- Improved buffer closing that preserves window layout
...
-- Set up keymaps for notification history
...
return ft_providers[filetype] or { "lsp", "treesitter", "indent" }
...
-- Set custom highlights for folds
...
-- Fancy UI effects and animations
...
-- Don't display animations when scrolling with the mouse
...
resize_window = animate.gen_subscroll.window({ force_final = true }),
